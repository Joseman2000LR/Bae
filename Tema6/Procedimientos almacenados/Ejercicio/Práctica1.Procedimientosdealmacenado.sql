...
4- EJECUTE EL PROCEDIMIENTO ALMACENADO "pa_empleados_sueldo" SIN PARÁMETROS. ¿QUÉ SUCEDE? ¿POR QUÉ?
 EXECUTE PA_EMPLEADOS_SUELDO;
5- ELIMINE EL PROCEDIMIENTO ALMACENADO "pa_empleados_actualizar_sueldo" SI EXISTE. 
IF OBJECT_ID('PA_EMPLEADOS_ACTUALIZAR_SUELDO') IS NOT NULL DROP PROCEDURE PA_EMPLEADOS_SUELDO;
6- CREE UN PROCEDIMIENTO ALMACENADO LLAMADO "pa_empleados_actualizar_sueldo" QUE ACTUALICE LOS SUELDOS IGUALES AL 
ENVIADO COMO PRIMER PARÁMETRO CON EL VALOR ENVIADO COMO SEGUNDO PARÁMETRO. CREATE PROCEDURE PA_EMPLEADOS_SUELDO 
DROP PROCEDURE PA_EMPLEADOS_SUELDO @SUELDO1 DECIMAL(6, 2) @SUELDO2 DECIMAL(6, 2) AS
BEGIN
    UPDATE EMPLEADO
    SET
        SUELDO= @SUELDO2
...
9- EJECUTE EL PROCEDIMIENTO ALMACENADO "pa_empleados_actualizar_sueldo" ENVIANDO EN PRIMER LUGAR EL PARÁMETRO @SUELDONUEVO Y 
EN SEGUNDO LUGAR @SUELDOANTERIOR (PARÁMETROS POR NOMBRE). 
EXECUTE PA_EMPLEADOS_SUELDO @SUELDO1 1300 @sueldo2 '1350';
...
12- CREE UN PROCEDIMIENTO LLAMADO "pa_sueldototal" QUE RECIBA EL DOCUMENTO DE UN EMPLEADO Y MUESTRE SU NOMBRE, APELLIDO Y 
EL SUELDO TOTAL (RESULTADO DE LA SUMA DEL SUELDO Y SALARIO POR HIJO, QUE ES DE 200 € SI EL SUELDO ES MENOR A 1500 € Y 100 €,
 SI EL SUELDO ES MAYOR O IGUAL A 1500€). COLOQUE COMO VALOR POR DEFECTO PARA EL PARÁMETRO EL PATRÓN "%". 
...
18- EJECUTE EL PROCEDIMIENTO "pa_ departamento" SIN PASAR VALOR PARA EL PARÁMETRO "departamento". LUEGO MUESTRE LOS VALORES DEVUELTOS POR EL PROCEDIMIENTO. ¿QUÉ SUCEDE? ¿POR QUÉ? 
...
23- EJECUTE EL PROCEDIMIENTO ANTERIOR ENVIANDO EL DOCUMENTO DE UN EMPLEADO EN CUYO CAMPO "sueldo" CONTENGA "null". ¿QUÉ SUCEDE? ¿POR QUÉ? 24- EJECUTE EL PROCEDIMIENTO ANTERIOR SIN ENVIAR VALOR PARA EL PARÁMETRO "documento". ¿QUÉ SUCEDE? ¿POR QUÉ?